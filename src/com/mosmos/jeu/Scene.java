...
import com.mosmos.affichage.CompteARebours;
import com.mosmos.affichage.Score;
import com.mosmos.audio.Audio;
import com.mosmos.objets.Bloc;
import com.mosmos.objets.Objet;
import com.mosmos.objets.Piece;
import com.mosmos.objets.TuyauRouge;
import com.mosmos.personnage.Champ;
import com.mosmos.personnage.Mario;
import com.mosmos.personnage.Tortue;
...
public class Scene extends JPanel {
	...
	public void deplacementFond(){ // Déplacement des images "fixes" de l'écran simulant le déplacement de mario 
		...
		private boolean partieGagnee() {
			if(this.compteARebours.getCompteurTemps() > 0 && this.mario.isVivant() == true && this.score.getNbPieces() == 10 && this.xPos > 4400){
				if(this.ok == true) {
	...
	public void paintComponent(Graphics g) { // Dessin de toutes les images visibles à l'écran (appel toutes les 3 ms environ)
        ...
        // Image de mario
 	    ...
 	    g2.setFont(police);
 	    g2.drawString(this.score.getNbPieces() + "pièce(s) trouvée(s) sur " + this.score.getNB_TOTAL_PIECES(), 460, 25);
